...

{
  ...
  virtualisation.oci-containers.containers."dns" = {
    image = "docker.io/spx01/blocky:v0.26";
    volumes = [
  ...
  virtualisation.oci-containers.containers."fileflows" = {
    image = "docker.io/revenz/fileflows:25.07";
    volumes = [
      "/etc/localtime:/etc/localtime:ro"
    ];
    labels = {
  ...
  virtualisation.oci-containers.containers."jellyseerr" = {
    image = "docker.io/fallenbagel/jellyseerr:2.7.1";
    volumes = [
      "/etc/localtime:/etc/localtime:ro"
  ...
  virtualisation.oci-containers.containers."netalertx" = {
    image = "docker.io/jokobsk/netalertx:25.7.4";
    volumes = [
      "/etc/localtime:/etc/localtime:ro"
  ...
  virtualisation.oci-containers.containers."proxy" = {
    image = "docker.io/traefik:v3.4.4";
    environment = {
  ...
  virtualisation.oci-containers.containers."speedtest-tracker" = {
    image = "docker.io/linuxserver/speedtest-tracker:1.6.5";
    environment = {
  ...
  virtualisation.oci-containers.containers."tubearchivist-es" = {
    image = "docker.io/elasticsearch:8.18.3";
    environment = {
