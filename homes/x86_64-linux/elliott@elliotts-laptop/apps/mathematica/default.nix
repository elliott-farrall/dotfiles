...

{
  ...
  wayland.windowManager.hyprland.settings.windowrule = [ "float, title:^(Mathematica)$" ];

  programs.waybar.settings.mainBar."hyprland/workspaces".window-rewrite = { "mathematica" = "󰪚"; };
